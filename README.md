...
![Tests](https://img.shields.io/badge/tests-4161_unit_|_483_E2E-brightgreen?style=for-the-badge)
...
| **Tests**         | 4,161 unit + 483 E2E tests (474 passed / 9 skipped), 0 TypeScript errors, 0 lint warnings |
...
npm run test:run       # Single run (4,161 unit tests)
