...
export class NeMoSimulator extends BaseSimulator {
  constructor() {
    ...
    this.registerCommand('train', this.handleTrain.bind(this), {
      ...
      flags: [
        ...
        { long: 'gpus', description: 'Number of GPUs to use (default: 8)', takesValue: true },
        { long: 'iterations', description: 'Number of training iterations (default: 1000)', takesValue: true },
      ],
      examples: [
    ...
    this.registerCommand('burn-in', this.handleBurnIn.bind(this), {
      ...
      flags: [
        ...
        { long: 'model', description: 'Model name for burn-in (default: gpt3-7b)', takesValue: true },
      ],
      examples: [
        'nemo burn-in',
  ...
  private handleTrain(parsed: ParsedCommand, context: CommandContext): CommandResult {
  ...
  private getNode(context: CommandContext): any {
