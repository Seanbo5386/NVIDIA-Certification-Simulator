            ...
            <div className={`relative z-10 w-full max-w-5xl bg-gray-900/90 border border-gray-700/50 rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-700 delay-100 ${isVisible ? 'translate-y-0 scale-100' : 'translate-y-10 scale-95'}`}>
                ...
                <div className="relative overflow-hidden bg-gradient-to-r from-black to-gray-900 p-10 text-center border-b border-gray-800">
                    ...
                    <div className="flex justify-center mb-6">
                        <div className="w-20 h-20 bg-nvidia-green rounded-2xl flex items-center justify-center shadow-[0_0_15px_rgba(118,185,0,0.3)] animate-pulse-slow">
                            <span className="text-black font-bold text-5xl select-none">N</span>
                        </div>
                    </div>
                    ...
                    <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mt-4 px-4 font-light">
                        The ultimate environment for mastering NVIDIA Data Center technologies.
                        Train, test, and certify in a risk-free virtual world.
                    </p>
                </div>
                ...
                <div className="p-8 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h3 className="text-xl font-semibold text-white">NCP-AII Certification Ready</h3>
                        </div>
                        <p className="text-gray-300 leading-relaxed text-base">
                            Designed specifically for the <strong>NVIDIA Certified Professional - AI Infrastructure (NCP-AII)</strong> exam. This simulator provides a comprehensive platform to practice system administration, troubleshooting, and optimization tasks without needing physical hardware.
                        </p>
                        ...
                        <p className="text-gray-300 leading-relaxed text-base">
                            Interact with a full-stack simulation of a DGX H100 SuperPOD. From managing physical connections to configuring complex workloads with Slurm and Kubernetes, every aspect is simulated with high fidelity.
                        </p>
                    </div>
