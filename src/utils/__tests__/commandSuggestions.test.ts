...
describe("Command Suggestions", () => {
  ...
  describe("getContextualSuggestions", () => {
    it("should return suggestions based on objectives", () => {
      ...
      expect(
        names.some((n) => n.includes("nvidia") || n.includes("dcgmi")),
      ).toBe(true);
    });
  ...
  describe("formatCommandList", () => {
    ...
    it("should include help instruction", () => {
      ...
      expect(list).toContain("help <command>");
    });
  });
});
...
describe("Enhanced Error Feedback", () => {
  describe("getEnhancedErrorFeedback", () => {
    ...
    it("should provide feedback for MST driver error", () => {
      const feedback = getEnhancedErrorFeedback(
        "mlxconfig",
        "MST driver not loaded",
      );
  ...
  describe("generateStepCompletionFeedback", () => {
    ...
    it("should include tip about help command", () => {
      const feedback = generateStepCompletionFeedback("Test", ["cmd"], 1000);

      expect(feedback).toContain("help <command>");
    });
  });
